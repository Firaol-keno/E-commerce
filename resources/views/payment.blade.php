...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:16 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="card-body">
                    ...
                    <div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col-md-6">
														<div class="d-grid"><a href="{{ url('/shipping') }}" class="btn btn-light btn-ecomm"><i class="bx bx-chevron-left"></i>Back to Shipping</a>
														</div>
													</div>
													<div class="col-md-6">
														<div class="d-grid"><a href="{{ url('/cart-review') }}" class="btn btn-white btn-ecomm">Review Your Order<i class="bx bx-chevron-right"></i></a>
														</div>
													</div>
												</div>
											</div>
                               ...
                               @foreach($cartItems as $item)
														<div class="d-flex align-items-center">
															<a class="d-block flex-shrink-0" href="javascript:;">
																<img src="{{ asset('thumbnails/' . $item->product->thumbnail) }}" class="rounded" width="75" alt="Product">
															</a>
															<div class="ps-3">
																<h6 class="mb-1">{{ $item->product->product_name }}</h6>
																<div class="widget-product-meta"><span class="me-2">${{ $item->product->product_price }}</span><span class="">x {{$item->quantity}}</span>
																</div>
															</div>
														</div>
														<div class="my-3 border-top"></div>
                              @endforeach
												...
												<div class="card mb-0">
													<div class="card-body">
														...
														<p class="mb-2">Shipping: <span class="float-end">${{ $shipping }}</span>
														</p>
														<p class="mb-2">Taxes: <span class="float-end">${{ $taxes }}</span>
														</p>
...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:17 GMT -->
</html>