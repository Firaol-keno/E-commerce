...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-shop-grid-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:37:41 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <div class="toolbox d-flex flex-row align-items-center gap-2">
                      ...
                      <div class="btn-group">	
                        <a href="{{url('/grid-view')}}" class="btn btn-primary"><i class='bx bxs-grid mx-0'></i></a>
                        <a href="{{url('/list-view')}}" class="btn btn-outline-primary"><i class='bx bx-list-ul mx-0'></i></a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card product-card">
                        ...
                        <img src="{{ asset('thumbnails/' . $product->thumbnail) }}" class="card-img-top" alt="{{ $product->product_name }}">
                        <div class="card-body">
                            <div class="product-info">
                                <a href="javascript:;">
                                    <p class="product-category font-13 mb-1">{{ $product->category->title }}</p>
                                </a>
                                <a href="{{ url('/dashboard.show', $product->id) }}">
                                    <h6 class="product-name mb-2">{{ $product->product_name }}</h6>
                                </a>
                                <div class="d-flex align-items-center">
                                    <div class="mb-1 product-price">
                                        @if($product->original_price)
                                            <span class="me-1 text-decoration-line-through">${{ $product->original_price }}</span>
                                        @endif
...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-shop-grid-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:02 GMT -->
</html>