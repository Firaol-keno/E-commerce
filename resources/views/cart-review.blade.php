...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-review.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:17 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                                  ...
                                  <div class="col-12 col-lg-6">
                                    <div class="d-lg-flex align-items-start gap-3">
                                      <div class="cart-img text-center text-lg-start">
                                        <img src="{{ asset('thumbnails/' . $item->product->thumbnail) }}" width="130" alt="{{ $item->product->product_name }}">
                                      </div>
                                    ...
                                    <div class="text-center">
                                      <div class="d-flex gap-2 justify-content-center justify-content-lg-end"> 
                                        <form action="{{ route('cart.destroy', $item->id) }}" method="POST">
                                          @csrf
                                          @method('DELETE')
                                          <button type="submit" class="btn btn-primary btn-ecomm"><i class='bx bx-x-circle'></i>
                                          </button>
                                      </form>
                          ...
                          <div class="card">
                            ...
                            <div class="card mb-0">
                              <div class="card-body">
                                  ...
                                  <div class="my-4"></div>
                                  <div class="d-grid">
                                      <a href="javascript:;" class="btn btn-primary btn-ecomm">Proceed to Checkout</a>
                                  </div>
                              </div>
                          </div>
                           </div>
