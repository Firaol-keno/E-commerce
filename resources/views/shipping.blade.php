...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-shipping.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:16 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="card-body">
                    ...
                    <div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col-md-6">
														<div class="d-grid"><a href="{{ url('/checkout-detail') }}" class="btn btn-light btn-ecomm"><i class="bx bx-chevron-left"></i>Back to Details</a>
														</div>
													</div>
													<div class="col-md-6">
														<div class="d-grid"><a href="{{ url('/payment') }}" class="btn btn-primary btn-ecomm">Proceed to Payment<i class="bx bx-chevron-right"></i></a>
														</div>
													</div>
												</div>
											</div>
