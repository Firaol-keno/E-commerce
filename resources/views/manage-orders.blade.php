...
<!-- Mirrored from codervent.com/fobia/demo/ltr/pages-user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:42:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
 ...
 <!--start wrapper-->
    <div class="wrapper">
       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
        ...
        <li><a href="{{url('/manage-orders')}}">
          <ion-icon name="ellipse-outline"></ion-icon>Manage Order
        </a>
        </li>
          @endif
            </ul>         
          <li class="menu-label">Forms & Tables</li>
            <ul>
              ...
              <li> <a href="{{url('/logout')}}" onclick="stopUpdatingCartCount();">
                      ...
                      <table class="table align-middle mb-0">
                        <thead class="table-light">
                         ...
                         <tbody>
                          ...
                          <tr>
                          <td>{{ $cart->user->firstname}}</td>
                          <td><img src="{{ asset('avatars/' . $cart->user->avatar) }}" class="product-img-2" alt="product img"></td>
                          <td>{{ $cart->product->product_name}}</td>
                          <td><img src="{{ asset('thumbnails/' . $cart->product->thumbnail) }}" class="product-img-2" alt="product img"></td>
