...
<!-- Mirrored from codervent.com/fobia/demo/ltr/table-advance-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:42:24 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                       ...
                       <td>{{$i= $i + 1}}</td>
                        <td>
                          <div class="d-flex align-items-center gap-3 cursor-pointer">
                             <img src="{{ asset('avatars/' . $user->avatar) }}" class="rounded-circle" width="44" height="44" alt="">
                             <div class="">
                        ...
                        <td>
                          <div class="table-actions d-flex align-items-center gap-3 fs-6">
                            ...
                            <a href="{{ route('manage-orders')}}" class="btn btn-primary btn-ecomm"><i class='bx bx-edit'></i></a>
