...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:16 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
              ...
              <div class="card shadow-sm border-0">
                <div class="card-body">
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center mb-3">
													<div class="">
														<img src="{{ asset('avatars/' . $currentUser->avatar) }}" width="80" alt="" class="rounded-circle p-1 shadow-sm">
													</div>
													<div class="ms-3">
                        ...
                        <div class="container mt-5">
                          ...
                          <div class="form-body">
                              <form class="row g-3" method="POST" action="{{ route('shipping_address.store') }}">
                                  @csrf
                                  <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                      <div class="d-grid">
                                          <a href="{{ url('/add-cart') }}" class="btn btn-light btn-ecomm">
