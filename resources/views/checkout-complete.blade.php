...
<!-- Mirrored from codervent.com/fobia/demo/ltr/ecommerce-checkout-complete.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 06:38:17 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
         ...
         <div class="page-content">
          ...
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="btn btn-primary mt-3" href="ecommerce-shop-grid-view.html">Go back shopping</a>
              <a class="btn btn-white mt-3" href="javascript:;"><i class="bx bx-map"></i>Track order</a>
            </div>
          </div>
